...
<head>
 ...
 <title><%=attributes.getValue("Implementation-Title")%></title>
</head>

<body bgcolor="#FFFFFF">

<h1 align="center"><%=attributes.getValue("Implementation-Title")%> version "<%=attributes.getValue("Implementation-Version")%>"</h1> 
